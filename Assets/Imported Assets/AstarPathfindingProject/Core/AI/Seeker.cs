...
public class Seeker : MonoBehaviour, ISerializationCallbackReceiver {
	 ...
	 */
	public Path StartPath (Pathfinding.Path p, OnPathDelegate callback = null, int graphMask = -1) {
	...
	void StartPathInternal (Pathfinding.Path p, OnPathDelegate callback) {
